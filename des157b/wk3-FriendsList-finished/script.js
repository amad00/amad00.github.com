...
Parse.initialize("Aas6WNqm3pOofRYmx2lk8a5pxrFzFpq7CIwOtFcQ","exbdyz2HA6cdFnyOKI6UARCGLfCNnAXdj7h3Or4F");
    ...
    if(youAreSure){
        ...
        try{
            ...
            try{
                ...
                console.log('Error while deleting ParseObject', error);
            }
        } catch (error){
            console.log('Error while retrieving ParseObject', error);
        }
    }
}
...
async function displayFriends() {
    ...
    try{
        ...
        consple.log('Error while fetching friends', error);
    }
}
