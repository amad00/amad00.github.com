    ...
    async function displayResponseOverlay(cardID) {
        ...
        try {
            ...
            results.forEach(function (thisResponse) {
                wordTags[0].textContent = `${capitalizeFirstLetter(thisResponse.get("q1"))}`;
                wordTags[1].textContent = `${capitalizeFirstLetter(thisResponse.get("q2"))}`;
                wordTags[2].textContent = `${capitalizeFirstLetter(thisResponse.get("q3"))}`;
                paragraphTag.textContent = `${capitalizeFirstLetter(thisResponse.get("q4"))}`;
                ...
                overlayBg.style.backgroundColor = "red";
